// ============================================================
// File: src/components/ui/PaymentConfirmModal.jsx
...
export function PaymentConfirmModal({
  ...
  return createPortal(
    ...
    >
      <div
        style={{ background: "#0d1424", border: "1px solid #1e293b", borderRadius: 16, padding: 24, width: "100%", maxWidth: 400 }}
      ...
      >
        ...
        <div style={{ marginBottom: 16 }}>
          <label style={{ display: "block", fontSize: 11, color: "#64748b", textTransform: "uppercase", letterSpacing: "0.6px", fontWeight: 700, marginBottom: 8 }}>
            Kwota ({amountLabel})
          </label>
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            {suggestedAmount != null && (
              <button
                ...
                style={{ padding: "8px 12px", borderRadius: 8, border: "1px solid #10b98144", background: "transparent", color: "#10b981", fontSize: 12, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" }}
              >
                Sugestia
              </button>
            )}
            {maxAmount != null && (
              <button
                ...
                style={{ padding: "8px 12px", borderRadius: 8, border: "1px solid #3b82f644", background: "transparent", color: "#3b82f6", fontSize: 12, fontWeight: 700, cursor: "pointer" }}
              >
                MAX
              </button>
            )}
        ...
        <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
          ...
          <button
            ...
            disabled={!isValid}
            style={{ padding: "10px 24px", borderRadius: 8, border: "none", background: isValid ? "#10b981" : "#1e293b", color: isValid ? "#fff" : "#475569", cursor: isValid ? "pointer" : "not-allowed", fontWeight: 700, fontSize: 14 }}
          >
            ✅ Potwierdź
          </button>
        </div>
