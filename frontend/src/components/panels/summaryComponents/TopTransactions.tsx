        ...
        return (
          ...
          >
            ...
            <div style={{
              ...
              background: i === 0 ? "#f59e0b22" : "#1e293b",
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ color: "#475569", fontSize: 11, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                › {tx.subcategoryName}
                {tx.description && <span style={{ color: "#334155" }}> · {tx.description}</span>}
              </div>
            </div>
            ...
            <div style={{ textAlign: "right", flexShrink: 0 }}>
              <div style={{ color: "#e2e8f0", fontWeight: 800, fontSize: 14 }}>{fmt(tx.amount)}</div>
              <div style={{ color: "#475569", fontSize: 10 }}>{pct.toFixed(1)}% wydatków</div>
            </div>
          </DividerRow>
        );
      })}
