...
export function BarChart({ data, color = c.success }) {
...
// ── Badge (colored pill) ─────────────────────────────────────
export function Badge({ children, color = c.success }) {
  return (
...
// ── Toggle switch ────────────────────────────────────────────
export function Toggle({ value, onChange, label, color = c.success }) {
  return (
...
export function CollapsibleSection({ title, children, defaultOpen = true, style: extraStyle = {} }) {
  ...
  const cardStyle = { background: c.surface, border: `1px solid ${c.border}`, borderRadius: 16, padding: 16, marginBottom: 12 };
  return (
