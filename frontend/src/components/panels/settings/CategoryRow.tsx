...
interface CategoryRowProps {
  ...
  onUpdate:         (id: string, name: string, parentId: string | null, updates: Record<string, unknown>) => void;
}

export function CategoryRow({ cat, expandedCatId, setExpandedCatId, onUpdate }: CategoryRowProps) {
