...
export function LuxmedSection() {
  ...
  const [maxPercent, setMaxPercent] = useState<number | string>(90);
  const [maxTotal,   setMaxTotal]   = useState<number | string>(500);
  ...
  const inputStyle: React.CSSProperties = { ...s.input, width: 90, textAlign: "center" };
